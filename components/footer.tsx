...
import { Github, Twitter, Linkedin, Podcast } from 'lucide-react'
      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="mt-2 text-sm text-muted-foreground max-w-xs">{siteConfig.description}</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  href={siteConfig.socials.podcast}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-sm text-foreground/70 transition-colors hover:text-primary"
                >
        ...
        <div className="mt-10 border-t border-border/40 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="font-mono text-xs text-muted-foreground/60">v0.1.0 // hacky experiments</p>
        </div>
      </div>
    </footer>
  )
